...
function updateHouseData(action) {
    ...
    var aname = $(".filter-area>li.active").val();
    ...
    $.get('/api/house/search/', params, function (result) {
        if (result.code==200){
            var house_info_html = template('house-info-list', {houses: result.house_info});
